...
As Nancy mentioned earlier, violin plots (`r emo::ji("violin")`) are very similar to boxplots. The primary difference is that they also show the probability density (like a density plot!) that is rotated on it's side. Leslie is eager to get going.

```{r violin}
violin.funding <- gun.research %>%
  ggplot(aes(y = Funding/1000000000)) +
  geom_violin() + 
  theme_minimal() +
  labs(y = "Research funding for 2004-2015 (billions of dollars)") 
