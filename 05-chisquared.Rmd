...
## Achievement 2: Computing and comparing observed and expected values for the groups {#obsexp}
...
Which of these is a common value for an _alpha_ in most fields?
...
Kiara mentions to Leslie that one process to organize statistical tests like $\chi^2$ is _null hypothesis significance testing_ or NHST. Leslie asks if this is the same as the chi-squared goodness-of-fit test? Kiara says no and Leslie decides she will look that up later (see Box \@ref(ch5leslie2)). Kiara writes out the steps of NHST:
...
Which of the following influence the size of a $\chi^2$ statistic (choose all that apply):

* $\chi^2$ compares means of groups 
* $\chi^2$ can be negative or positive 
* $\chi^2$ is larger when there is a bigger difference between observed and expected 
* $\chi^2$ and $\alpha$ are two symbols for the same thing
